...
//             `http://artory-prod-env.eba-axnhdqgn.ap-northeast-2.elasticbeanstalk.com/naverlogin?accessToken=${access_token}`
//           );
...
//           const response = await axios.get(
//             `http://artory-prod-env.eba-axnhdqgn.ap-northeast-2.elasticbeanstalk.com/kakaologin?accessToken=${access_token}`
//           );
//           setTokenData(response.data);
//           console.log('data : ', response.data);
//           console.log('access Token : ', response.data.accessToken);
