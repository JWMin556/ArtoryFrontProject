...
// export default function NaverLogin() {
//   const NAVER_CLIENT_ID = '27AEJS87AXoGop3MoHhW'; //개발용 '4yrLNCK6RQMeFj95vayh' // 릴리즈용 '27AEJS87AXoGop3MoHhW';
//   const STATE = 'YOUR_RANDOM_STATE';
...
export default function NaverLogin() {
  ...
  const STATE = 'YOUR_RANDOM_STATE';
  //const NAVER_REDIRECT_URI = 'http://artory-powerful-server.store/oauth/kakao/callback' //서버 배포시 사용하는 redirect주소입니다.
