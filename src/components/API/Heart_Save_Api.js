...
export const saveApi =async (exhibitionId)=>{
        ...
        try {
            const response = await axios.post(`${SaveUrl}exhibition-scrapped?exhibitionId=${exhibitionId}`,
            {
...
export const saveCancelApi =async (exhibitionId)=>{
    ...
    try {
        const response = await axios.post(`${SaveUrl}exhibition-disScrapped?exhibitionId=${exhibitionId}`,
        {
            //  exhibitionId: exhibitionId.item
        },
        {
...
export const heartApi =async (exhibitionId)=>{
    ...
    try {
        const response = await axios.post(`${HeartUrl}exhibition-liked?exhibitionId=${exhibitionId}`,
        {
...
export const heartCancelApi =async (exhibitionId)=>{
    ...
    try {
        const response = await axios.post(`${HeartUrl}exhibition-disliked?exhibitionId=${exhibitionId}`,
        {
            //exhibitionId: exhibitionId
        },
        {
