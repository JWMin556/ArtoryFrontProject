    ...
    <HeaderContainer>
        <HeaderWrap>
            <HeaderLeftWrap> 
                ...
                <Link style={{display:'flex', alignItems:'center', marginLeft:'25%', textDecoration:'none', color:"#F5F5F5", fontSize:"14px", fontFamily:"Pretendard", fontWeight:"500", lineHeight:"18.63px", letterSpacing:"0.49px", wordWrap:"break-word"}} to="/">
